---
title: "Using file-backed matrices - FBM"
author: "Alice MacQueen"
date: 2022-01-13
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using file-backed matrices - FBM}
...
![CLMB_vs_KBSM](../man/figures/GWAS_significance_thr_log10p_0_CLMB_BIOMASS_vs_KBSM_BIOMASS.png){ width=50% }

and this:

![CLMB_vs_PKLE](../man/figures/GWAS_significance_thr_log10p_0_CLMB_BIOMASS_vs_PKLE_BIOMASS.png){ width=50% }
...
![upset_ex](../man/figures/Ex_Upset.png){ width=50% }
...
upset_1Mb  
```
![upset_ex](../man/figures/Ex_Upset_1Mb.png){ width=50% }
...
sel_snp_annos <- readRDS(anno_file)
```
